...
if (canonicalUrl) {
    canonicalUrl.href = window.location.origin + window.location.pathname + "?id=" + productId;
}
...
if (ogTitle) {
    ogTitle.content = `${product.name} | Love Zone`;
}

if (ogDescription) {
    ogDescription.content =
        `Buy ${product.name} in Pakistan with discreet packaging and fast delivery from Love Zone.`;
}
